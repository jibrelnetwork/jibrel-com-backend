...
class IndividualKYCSubmission(BaseKYCSubmission):
    ...
    occupation = models.CharField(choices=constants.OCCUPATION_CHOICES, max_length=320)
    occupation_other = models.CharField(max_length=320)
    income_source = models.CharField(choices=constants.INCOME_SOURCE_CHOICES, max_length=320)
