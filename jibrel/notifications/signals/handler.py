...
from ccwt.contrib.wire.models import DepositWireTransferOperation
from ccwt.contrib.wire.signals import wire_transfer_deposit_approved, wire_transfer_deposit_rejected
from ccwt.models import Operation
