...
from ccwt import module_name
from ccwt.contrib.wire.managers import DepositBankAccountManager, DepositWireTransferOperationManager, \
    WithdrawalWireTransferOperationManager, BankAccountManager
from ccwt.models import Account, Operation
from ccwt.settings import USER_MODEL
