...
CARD_BACKEND = getattr(settings, f'{module_name}_CARD_BACKEND', {})
CARD_BACKEND_ENABLED = (f'{module_name.lower()}.contrib.card' in settings.INSTALLED_APPS) and CARD_BACKEND
